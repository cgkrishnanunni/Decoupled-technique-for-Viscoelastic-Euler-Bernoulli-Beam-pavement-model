...
function gE=gE(t,q1,q2,k,Cof,Tu1,Tu2,Fz,V,L,B,h1,E1,E2,MU)
%----BEAM DETAILS---------------------------------------------------------
P= 2373;
...
b=((pi*k));                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
gE=(1/P*Ar)*(-MU*q2-(K1+((GP*b*b)/L^2)+(D1*B*b*b*b*b)/L^4)*q1-(2*K3*Cof)-((V1*(b)^(4))/L^4)*(Tu1+Tu2)+(2/L)*sin((b*V*t)/L)*Fz);
end
